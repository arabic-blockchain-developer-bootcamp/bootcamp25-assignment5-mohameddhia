...
contract Assignment5 {
    ...
    function addUser(uint _id , string calldata _name , address _userAddress) public{
        // Fill in the logic
        require(keccak256(abi.encodePacked(userNames[_userAddress])) == keccak256(abi.encodePacked(''))
        ,'User Does Exist');
